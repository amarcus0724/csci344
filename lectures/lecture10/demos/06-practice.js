...
const getImageUrls = (statArray) => {

    const getImgURL = item => item.image_url;

    function filterOutUndefineds(item) {
    ...
    return statArray.map(getImgURL).filter(filterOutUndefineds);
}
